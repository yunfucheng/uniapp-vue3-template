...
export class DataManager {
    ...
    return [
      {
        ...
        location: '乌翁屯',
        image: '',
        userAvatar: 'http://src.wwen.cc/Avatar/avatar004.jpg',
        userNickname: '花开富贵',
        time: '刚刚',
      },
      {
        ...
        userAvatar: 'http://src.wwen.cc/Avatar/avatar003.jpg',
        userNickname: '风中的男人',
        time: '30分钟前',
      },
      {
    ...
    return [
      {
        ...
        image: 'http://src.wwen.cc/Banner/ww01.jpg',
        status: '营业中',
        tags: ['日常用品', '粉店'],
        phone: '',
        supportPhone: false,
      },
      {
        ...
        location: '乌翁屯 | 篮球场旁边',
        image: 'http://src.wwen.cc/Banner/ww02.jpg',
        status: '营业中',
        tags: ['日常用品', '快递代收'],
        phone: '',
        supportPhone: false,
  ...
  static getDefaultPhotoWallItems() {
    return [
      {
        id: 1,
        imageUrl: 'http://src.wwen.cc/PhotoWall/wall001.jpg',
        userAvatar: 'http://src.wwen.cc/Avatar/avatar005.jpg',
        userNickname: '幸福一生',
        time: '5天前',
      },
      {
        id: 2,
        imageUrl: 'http://src.wwen.cc/PhotoWall/wall002.jpg',
        userAvatar: 'http://src.wwen.cc/Avatar/avatar006.jpg',
        userNickname: '爱江山更爱美人',
        time: '1天前',
      },
      {
        id: 3,
        imageUrl: 'http://src.wwen.cc/PhotoWall/wall003.jpg',
        userAvatar: 'http://src.wwen.cc/Avatar/avatar007.jpg',
        userNickname: 'Aser0327',
        time: '5天前',
      },
      {
        id: 4,
        imageUrl: 'http://src.wwen.cc/PhotoWall/wall004.jpg',
        userAvatar: 'http://src.wwen.cc/Avatar/avatar008.jpg',
        userNickname: '俗了月.',
        time: '半月前',
      },
      {
        id: 5,
        imageUrl: 'http://src.wwen.cc/PhotoWall/wall005.jpg',
        userAvatar: 'http://src.wwen.cc/Avatar/avatar009.jpg',
        userNickname: '🌸豌豆糕🎀',
        time: '半月前',
      },
    ];
