...
export default {
  ...
  methods: {
    ...
    publish() {
      ...
      if (!this.price || Number.isNaN(Number(this.price))) {
...
<style scoped>
.add-sale-page { background-color: var(--theme-bg-color-secondary); height: 100vh; display:flex; flex-direction:column; }
