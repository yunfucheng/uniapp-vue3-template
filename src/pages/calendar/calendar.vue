<template>
  <view class="calendar-detail-container">
    ...
    <!-- 主要内容区域 -->
    <scroll-view v-if="calendarData" class="content-scroll" scroll-y="true">
      <view class="content-padding">
        <!-- 日期信息卡片 -->
        <view class="date-card">
          <view class="date-main">
            <text class="date-number">
              {{ formatDateNumber(calendarData.date) }}
            </text>
            <view class="date-info">
              <text class="date-detail">
                {{ formatDateDetail(calendarData.date) }}
              </text>
              <text class="lunar-date">
                {{ calendarData.lunarCalendar }}
              </text>
              <text class="year-tips">
                {{ calendarData.yearTips }}年
              </text>
            </view>
          </view>
          ...
          <view class="date-info-row">
            ...
            <text v-if="calendarData.indexWorkDayOfMonth > 0" class="info-item">
        ...
        <view class="suit-card">
          <view class="card-header">
            <text class="card-title good-title">
              宜
            </text>
          </view>
        ...
        <view class="avoid-card">
          <view class="card-header">
            <text class="card-title bad-title">
              忌
            </text>
          </view>
          <view class="items-grid">
