<template>
  <view class="sale-detail">
    ...
    <view class="bottom-actions">
      ...
      <u-button class="contact-btn" color="#09BE4F" shape="circle" @click="onContact">联系卖家</u-button>
    </view>
  </view>
</template>
...
<style scoped>
.sale-detail { margin: 24rpx; background:#fff; border-radius: 16rpx; overflow:hidden; box-shadow:0 4rpx 12rpx rgba(0,0,0,0.06); }
...
.price { font-size: 36rpx; color:#dc2626; font-weight:700; }
